...
<body>
	...
	<div class="Contacts">
		<div class="adds">
			...
			<p><i class="far fa-address-book"></i><b> Harsha</b><br><i class="fas fa-envelope-open"></i> harshacph08@gmail.com</br><i class="fas fa-mobile-alt"></i> 1234567890</br>Bangalore</br> Karnataka-560091</p>
		</div>
	</div>
<br clear="all">
	<div class="feed">
